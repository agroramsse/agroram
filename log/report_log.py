...
def process_all_logs_in_directory(directory="."):
    ...
    print("## 📊 Markdown: Table 8 Data: Access Statistics")
    print(format_markdown_table_grouped(access_data, access_header))

    print("## 📊 Markdown Table 9 Data, Oblivious Segment Tree: Setup, Search timings, and Storage")
    print(format_markdown_table_grouped(timing_data, timing_header))


# Uncomment to run
process_all_logs_in_directory("log/")
